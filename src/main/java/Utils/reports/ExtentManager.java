...
public class ExtentManager {
    ...
    public static ExtentReports createInstance() {
        ...
        String extentCss = ".report-name {font-size:0px} .report-name::after {content: 'Yaani Test Automation';font-size:14px !important} ";
        extentCss += ".nav-wrapper .brand-logo {font-size:0px} .nav-wrapper .brand-logo::after {content: 'Yaani';font-size:12px !important} ";
        ...
        extent.setSystemInfo("YaaniTest", "https://www.yaani.com/");
